...
int main()
{
	...
	std::cout << merge_brand_model<Car>(**arrayTruck) << std::endl;
	std::cout << merge_brand_model<Car>(**arrayBus) << std::endl;
	std::cout << merge_brand_model<Car, Car>(**arrayBus, **arrayTruck) << std::endl;
